...
function template_init()
{
	...
	if (!defined('DEFAULT_BESE_COLOR')){
		define('DEFAULT_BESE_COLOR', '#ebe0c0');
	}

	if (!defined('DEFAULT_BESE_COLOR_PRIMARY')){
		define('DEFAULT_BESE_COLOR_PRIMARY', '#be9a3b');
	}
	if (!defined('DEFAULT_BESE_COLOR_SECONDARY')){
		define('DEFAULT_BESE_COLOR_SECONDARY', '#a89e7a');
	}
...
function template_body_below()
{
	...
	echo '</div></div></div><!--#mainsag mainsol mainarea-->';
	...
	echo '</div></div></div><!-- #footer-rmd foot-l foot-r -->';
}
